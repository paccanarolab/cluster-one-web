            ...
            >
                ...
                <DialogContent style={{ display: "flex", flexDirection: "column", gap: "20px", marginBottom: "20px" }}>
                    <p style={{ fontSize: "1.5em", lineHeight: "1.5em", textAlign: "center" }}>
                        ...
                        It is based on the ClusterONE algorithm, which is a graph clustering algorithm that identifies dense regions in networks. Developed by PaccanaroLab
                    </p>
                ...
                <DialogActions style={{ justifyContent: 'center' }}>
                    ...
                    <ClusterOneParams
                        ...
                        initialView={true}
                    />
                    <Button color="primary" href='https://paccanarolab.org/clusteroneweb/doc/cl1web-docs.html' target="_blank">
                        Help
                    </Button>
                </DialogActions>
